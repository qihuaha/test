...
SECRET_KEY = 'django-insecure-iaslkwkjy4qir2h7g8e8t6zdeon&lv-sn4x1%$97^u=ugoz1a)'
...
DATABASES = {
    'default': {
        ...
        'PASSWORD': os.getenv("DB_PASSWORD", "rkWyvSsKSCkNiwwGJDgzLLFRfWnrNDUm"),
        'HOST': os.getenv("DB_HOST", "maglev.proxy.rlwy.net"),
        'PORT': os.getenv("DB_PORT", "54603"),
    }
}
